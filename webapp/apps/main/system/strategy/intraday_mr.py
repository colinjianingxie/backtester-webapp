class IntradayOLSMRStrategy(Strategy):
	...
	The z-score of the residuals time series is then calculated in a rolling fashion and if it exceeds an interval of thresholds
	...
	def calculate_signals_for_pairs(self):
		...
		We use OLS for this, although we chould use CADF.
		"""
