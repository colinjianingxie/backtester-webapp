...
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var s = (l = {
          appendHTMLElement: function (e, t, n) {
            ...
            return (
              (n = n || ""),
              ((l = document.createElement(e)).className = n),
              t ? t.appendChild(l) : document.body.appendChild(l),
              l
            );
          },
          remove: function (e) {
          ...
          addClass: function (e, t) {
            ...
            a.isUndefined(e.classList)
              ? l.hasClass(e, t) ||
                ((n = l.getClass(e)), l.setClass(e, (n ? n + " " : "") + t))
          ...
          removeClass: function (e, t) {
            var n = "";
            a.isUndefined(e.classList)
              ? ((n = (" " + l.getClass(e) + " ").replace(" " + t + " ", " ")),
                l.setClass(e, n.replace(/^\s\s*/, "").replace(/\s\s*$/, "")))
          ...
          getStyle: function (e, t) {
            ...
            return (
              (l && "auto" !== l) ||
                ...
                (l = (n = document.defaultView.getComputedStyle(e, null))
                  ? n[t]
                  : null),
              "auto" === l ? null : l
            );
          ...
          setLTRB: function (e, t) {
            ...
            ["left", "top", "right", "bottom"].forEach(function (l) {
              (n = a.isUndefined(t[l]) ? "" : t[l]),
                (e.style[l] = a.isNumber(n) ? n + "px" : n);
            });
          },
          ...
          getSize: function (e) {
            ...
            return (
              (r.test(n) || r.test(o) || a.isNull(n) || a.isNull(o)) &&
              "getBoundingClientRect" in e
          ...
          testProp: function (e) {
            for (
              var t = document.documentElement.style, n = 0, l = e.length;
              n < l;
              n += 1
            )
          ...
          getFormData: function (e) {
            ...
            return (
              t.add.apply(
                ...
                l
                  .find("input", e, n)
                  .concat(l.find("select", e, n))
                  .concat(l.find("textarea", e, n))
              ),
      ...
      (function (t) {
        ...
        (o = {
          YYYYMMDD: function (e) {
            return [
              e.getFullYear(),
              l.leadingZero(e.getMonth() + 1, 2),
              l.leadingZero(e.getDate(), 2),
            ].join("");
          },
          YYYY: function (e) {
          ...
          "hh:mm": function (e) {
            ...
            return (
              t > 12 && (t %= 12),
              l.leadingZero(t, 2) + ":" + l.leadingZero(n, 2)
            );
          },
          tt: function (e) {
          ...
          (l = {
            ...
            _convMilliseconds: function (e, n, l) {
              ...
              return (
                e in o &&
                !t.isNaN(n) &&
                r.reduce([n].concat([24, 60, 60, 1e3].slice(o[e])), l)
              );
            },
            ...
            parse: function (e, t) {
              ...
              return (
                ...
                !!a &&
                  (e.length > 8
                    ? ((n = ~e.indexOf("/") ? "/" : "-"),
                      (l = (a = a.splice(1))[0].split(n)),
                      (o = a[1] ? a[1].split(":") : [0, 0, 0]))
                    : ((l = [
                        (a = a[0]).substr(0, 4),
                        a.substr(4, 2),
                        a.substr(6, 2),
              ...
              return (
                S
                  ? ((s = new i(e)),
                    ...
                    (c = c.d))
                  : ((s = l.startDateOfMonth(e)), (c = l.endDateOfMonth(e))),
                ...
                r.forEachArray(r.range(d), function (e) {
                  ...
                  e % 7 || (m = f[e / 7] = []),
                    (t = l.start(p)),
                    (t = n ? n(t) : t),
                    (_ && l.isWeekend(t.getDay())) || m.push(t),
              ...
              return (
                ...
                r.map(c, function (n) {
                  var o,
                    r = t ? a : i;
                  return (
                    e > 5 && t && l.isWeekend(n) && (r = a / 2),
                    (o = { day: n, width: r, left: s }),
                    (s += r),
                    o
                  );
                })
            ...
            isBetweenWithDate: function (e, t, n) {
              return (
                (e = parseInt(l.format(e, "YYYYMMDD"), 10)),
                (t = parseInt(l.format(t, "YYYYMMDD"), 10)),
                (n = parseInt(l.format(n, "YYYYMMDD"), 10)),
                t <= e && e <= n
              );
            },
    ...
    function (e, t, n) {
      ...
      function m(e) {
        var t;
        l.isUndefined(e) && (e = Date.now()),
          (t = arguments.length > 1 ? u(arguments) : p(e) ? h(e) : d(e)),
          (this._date = t);
      }
    ...
    function (e, t, n) {
      ...
      e.exports = {
        createScheduleCollection: function (e) {
          var t = new a(s);
        ...
        pick2: function (e, t) {
          var n = l.pick.apply(null, arguments);
          return {
            val: function () {
              return n;
            },
        ...
        setAutoEllipsis: function (e, t, n) {
          l.forEach(i.find(e, t, !0), function (e) {
            (n || e.offsetWidth < e.scrollWidth) &&
              e.setAttribute("title", i.getData(e, "title"));
          });
        },
        set: function (e, t, n) {
          var o = t.split("."),
        ...
        getScheduleChanges: function (e, t, n) {
          ...
          return (
            l.forEach(t, function (t) {
              i.indexOf(t) > -1
                ? r.compare(e[t], n[t]) && (o[t] = n[t])
                : l.isUndefined(n[t]) || e[t] === n[t] || (o[t] = n[t]);
            }),
            l.isEmpty(o) ? null : o
          );
        },
        ...
        a = {
              ...
              (e._evt && e._evt[i]) ||
                ...
                "addEventListener" in e
                  ? "mouseenter" === t || "mouseleave" === t
                    ? ((r = function (t) {
                        (t = t || window.event), a._checkMouse(e, t) && s(t);
                      }),
                      e.addEventListener(
          ...
          _off: function (e, t, n, o) {
            ...
            if (a) {
              ...
              delete e._evt[i],
                l.keys(e._evt).length ||
                  (l.browser.msie && l.browser.version < 9
                    ? (e._evt = null)
                    : delete e._evt);
            }
          },
          once: function (e, t, n, o) {
            ...
            l.isObject(t)
              ...
              : a.on(
                  ...
                  t,
                  function l() {
                    n.apply(o || e, arguments), i._off(e, t, l, o);
                  },
                  o
                );
          },
          ...
          stop: function (e) {
            a.preventDefault(e), a.stopPropagation(e);
          },
          disableScrollPropagation: function (e) {
            a.on(e, "mousewheel MozMousePixelScroll", a.stopPropagation);
          },
          disableClickPropagation: function (e) {
            a.on(e, i.START.join(" ") + " click dblclick", a.stopPropagation);
          },
          ...
          mouseEvent: function (e, t) {
            ...
            return (
              ...
              o.msie && o.version < 9 && delete i.wheelDelta,
      ...
      (a.prototype.cssPrefix = "tui-view-"),
        ...
        (a.prototype.resize = function () {
          for (
            ...
            l.isFunction(t._onResize) && t._onResize.apply(t, e),
              (t = t.parent);
        }),
      ...
      (c.and = function (e) {
        ...
        (c.or = function (e) {
          ...
          return (
            ...
            (t = e.length),
            function (n) {
              for (var l = 1, o = e[0].call(null, n); l < t; l += 1)
                o = o || e[l].call(null, n);
              return o;
            }
          );
        ...
        (c.merge = function (e) {
          ...
          return (
            ...
            (o.items = n),
            (o.length = l.keys(o.items).length),
            o
          );
        }),
    ...
    function (e, t, n) {
      ...
      (u.schema = { required: ["title"], dateRange: ["start", "end"] }),
        ...
        (u.prototype.setAllDayPeriod = function (e, t) {
          (e = l.isString(e)
            ? i.parse(e.substring(0, 10))
            : new o(e || Date.now())),
            (t = l.isString(t)
              ? i.parse(t.substring(0, 10))
              : new o(t || this.start)),
            (this.start = e),
            this.start.setHours(0, 0, 0),
            (this.end = t || new o(this.start)),
            this.end.setHours(23, 59, 59);
        }),
        (u.prototype.setTimePeriod = function (e, t) {
          (this.start = new o(e || Date.now())),
            (this.end = new o(t || this.start)),
      ...
      e.exports = {
        bsearch: function (e, t, n, l) {
          var o,
            ...
            s = e.length - 1;
          for (l = l || a; r <= s; )
            if (((o = ((r + s) / 2) | 0), (i = l(n ? n(e[o]) : e[o], t)) < 0))
              r = o + 1;
            else {
              if (!(i > 0)) return o;
              s = o - 1;
    ...
    function (e, t, n) {
      ...
      l.inherit(r, a),
        ...
        (r.prototype.destroy = function () {
          for (
            var e = this.parent, t = this.sibling, n = 0, l = t.length;
            n < l;
            n += 1
          )
            if (t[n] === this) {
        ...
        (r.prototype.setSize = function (e, t) {
          ...
          (e = l.isNumber(e) ? e + "px" : e),
            (t = l.isNumber(t) ? t + "px" : t),
            (n.style.width = e),
            (n.style.height = t);
        }),
      ...
      var l = n(0),
        ...
        u = {
          ...
          _retriveScheduleDataFromDate: function (e, t) {
            ...
            return (
              !!a &&
              ((i = a.getRenderDateRange()),
              (n = i.length),
              (o = a.getRenderDateGrids()),
              l.forEach(i, function (e, n) {
                r.isSameDate(e, t) && (u = n);
              }),
              function (t) {
                var a = 0;
                return (
                  l.forEach(i, function (e, n) {
                    r.isSameDate(e, t) && (a = n);
                  }),
                  (a = s(a, 0)),
                  (a = c(a, n - 1)),
                  {
    ...
    function (e, t, n) {
      ...
      var l = n(0),
        ...
        c = {
          ...
          _retriveScheduleDataFromDate: function (e) {
            var t = e.getDate();
            return l.bind(function (n, o, a) {
              var r, c, d, h, p, m;
              return (
                (r = n.getHours() - a + u(n.getMinutes())),
                (c = new s(t).addMinutes(i.minutesFromHours(r))),
                (d = r),
                (h = new s(t).addMinutes(i.minutesFromHours(d))),
                (p = o.getHours() - a + u(o.getMinutes())),
                (m = new s(t).addMinutes(i.minutesFromHours(p))),
                l.extend({
                  target: e,
                  relatedView: e,
                  gridY: r,
      ...
      e.exports = function (e) {
        ...
        return function (e) {
          ...
          return (
            ...
            (t = l.pick(n, g))
              ? (f < 0 && (f = 0),
                f >= (p = t.getRenderDateRange()).length && (f = p.length - 1),
                (i = l.pick(p, f))
                  ? {
                      x: f,
                      y: g,
        ...
        (o.prototype.addMonth = function (e) {
          ...
          return (
            e &&
              (1 === o
                ? (a = l ? 29 : 28)
                : (e > 0 ? i.d.setMonth(o + 1, 0) : i.d.setMonth(t, 0),
                  (a = i.d.getDate()))),
            this.d.setMonth(o, Math.min(n, a)),
            this
          );
        }),
        ...
        (r.prototype.destroy = function () {
          ...
          (r.prototype._toggleDragEvent = function (e) {
            var n,
              l,
              a = this.container;
            e ? ((n = "on"), (l = "disable")) : ((n = "off"), (l = "enable")),
              o[l + "TextSelection"](a, s),
              o[l + "ImageDrag"](a, s),
              i[n](
                t.document,
    ...
    function (e, t, n) {
      ...
      l.inherit(h, s),
        ...
        (h.prototype._initializeGuideElement = function (e, t) {
          var n = e.cloneNode(!0);
          return (
            a.addClass(n, o.classname("splitter-guide")),
        ...
        (h.prototype._onDragStart = function (e) {
          ...
          s.addClass(o.classname("splitter-focused")),
            ...
            l.browser.msie ||
              a.addClass(document.body, o.classname("resizing"));
        }),
      ...
      (o.getRatio = function (e, t, n) {
        ...
        (o.prototype._rotate = function (e, t, n, l) {
          ...
          return (
            ...
            (l = l || parseFloat(Math.sin(a).toFixed(8))),
            this._subtract(t),
            (o = this.x),
            (i = this.y),
            (this.x = o * n - i * l),
    ...
    function (e, t, n) {
      ...
      i.inherit(f, l),
        ...
        (f.prototype._toggleIsAllday = function (e) {
          ...
          return (
            !!l &&
            (((t = u.find(s.classname(".checkbox-square"), l)).checked =
              !t.checked),
            !0)
          );
        }),
        ...
        (f.prototype._getYAndArrowDirection = function (e, t, n, l, o) {
          var i = "arrow-bottom",
            a = e - n;
          return (
            a < l ? ((a = t - l + 3), (i = "arrow-top")) : (a = a - l - 3),
            a + n > o && (a = o - n - l - 3),
        ...
        (f.prototype._getXAndArrowLeft = function (e, t, n, l, o) {
          var i,
            ...
            r = a - n / 2;
          return (
            r + n > o ? (i = a - (r = t - n + 8)) : (r += 8),
            r < l ? ((r = 0), (i = a - l - 8)) : (r = r - l - 8),
            { x: r, arrowLeft: i }
          );
        }),
        (f.prototype._calcRenderingData = function (e, t, n) {
          var l = this._getYAndArrowDirection(
              n.top,
              n.bottom,
              e.height,
              t.top,
          ...
          return {
            x: o.x,
            y: l.y,
            arrow: { direction: l.arrowDirection, position: o.arrowLeft },
          };
        }),
        (f.prototype._setArrowDirection = function (e) {
          ...
          t !== s.classname("arrow-bottom") &&
            ...
            e.position && (l.style.left = e.position + "px");
        }),
        ...
        (f.prototype._getRangeDate = function (e, t, n) {
          return (
            n &&
              (e.setHours(0, 0, 0),
              (t = h.isStartOfDay(t)
                ? h.convertStartDayToLastDay(t)
                : t.setHours(23, 59, 59))),
            { start: new m(e), end: new m(t) }
          );
        }),
    ...
    function (e, t, n) {
      ...
      i.inherit(u, l),
        ...
        (u.prototype._setPopupPositionAndArrowDirection = function (e) {
          ...
          (this._scheduleEl = c),
            (t = this._calcRenderingData(l, o, u)),
        ...
        (u.prototype._calcRenderingData = function (e, t, n) {
          ...
          return {
            x: o.x,
            y: l.y,
            arrow: { direction: o.arrowDirection, position: l.arrowTop },
          };
        }),
        (u.prototype._setArrowDirection = function (e) {
          ...
          t !== a.classname("arrow-left") &&
            ...
            e.position && (l.style.top = e.position + "px");
        }),
      ...
      (u.prototype.destroy = function () {
        ...
        (u.prototype.checkExpectedCondition = function (e) {
          ...
          return (
            ...
            !(
              !(n = (i = a.getClass(t)).match(o.daygrid.getViewIDRegExp)) ||
              n.length < 2
            ) &&
    ...
    function (e, t, n) {
      ...
      function m(e, t) {
        ...
        (this.options = l.extend(
          ...
          (this.ratio = l.bind(function (e) {
            return i.ratio(n.days, 100, e);
          })),
          (this.startCoord = [0, 0]),
          (this.guideElements = {}),
          (this.grids = t.grids);
      ...
      (m.prototype.destroy = function () {
        ...
        (m.prototype.clearGuideElement = function () {
          this.destroy();
        }),
        (m.prototype._getRatioValueInWeek = function (e) {
          return (this.grids[e] || { left: 100 }).left;
        }),
        (m.prototype._createGuideElement = function () {
          var e = document.createElement("div");
          return (e.innerHTML = c(this.options)), e.firstChild;
        }),
        (m.prototype._getGuideElement = function (e) {
          ...
          return l
            ? (n ||
                ...
                l.container.appendChild(n),
                (t[e] = n)),
              n)
            : null;
        }),
        (m.prototype._getCoordByDate = function (e) {
          for (
            var t = this.weeks,
              n = l.pick(this.view, "options", "workweek")
                ? this.days + 2
                : this.days,
              o = function (e, t) {
                return p(r.millisecondsTo("day", h(t - e)));
              },
              i = r.start(t[0].options.renderStartDate),
              a = e < i,
              c = new s(i),
              u = new s(i).addDate(a ? -n : n).addDate(-1),
              d = o(e, c),
              m = 0;
            !r.isBetweenWithDate(e, c, u);

          )
            c.addDate(a ? -n : n),
              (u = new s(c).addDate(n - 1)),
              (d = o(e, c)),
              (m += a ? -1 : 1);
          return [d, m];
        }),
        (m.prototype._getLimitedCoord = function (e, t, n) {
          var l,
            o = e[0],
            i = e[1];
          return (
        ...
        (m.prototype.start = function (e) {
          ...
          n.isCreationMode
            ? i &&
              !r.isSameMonth(u, i.start) &&
              (i.start.setMonth(u.getMonth()),
              i.start.setDate(1),
              i.end.setMonth(u.getMonth()),
              i.end.setDate(1))
            : ((a = (t = this._getCoordByDate(i.getStarts()))[0]),
              (c = t[1]),
              l.extend(
                this.options,
                {
            ...
            (l.isUndefined(a) || l.isUndefined(c)) &&
              ((a = (t = this._getCoordByDate(i.getStarts()))[0]), (c = t[1])),
            (this.startCoord = [a, c]),
            this.update(a, c);
        }),
        (m.prototype._updateGuides = function (e) {
          l.forEach(e, function (e) {
            ...
            (t.style.display = "block"),
              ...
              e.exceedL ? a.addClass(t, n) : a.removeClass(t, n),
              e.exceedR ? a.addClass(t, l) : a.removeClass(t, l);
          });
        }),
        (m.prototype._getOriginIndicate = function (e, t) {
          ...
          return (
            t[1] > e[1]
              ? ((o = e[0]), (i = this.days), (l = !0))
              : t[1] < e[1] && ((o = 0), (i = e[0] + 1), (n = !0)),
            {
              left: this._getRatioValueInWeek(o),
              width:
                this._getRatioValueInWeek(i) - this._getRatioValueInWeek(o),
              exceedL: n,
              exceedR: l,
            }
          );
        ...
        (m.prototype._getContainIndicate = function () {
          return { left: 0, width: 100, exceedL: !0, exceedR: !0 };
        }),
        (m.prototype._removeGuideElements = function (e) {
          var t = this.guideElements;
          l.forEach(e, function (e) {
            a.remove(t[e]), delete t[e];
          });
        }),
          ...
          this._removeGuideElements(c),
            l.forEach(s, function (e) {
              ...
              r &&
                ((t =
                  e === o[1]
                    ? n._getOriginIndicate(o, a)
                    : e === i[1]
                    ? n._getMouseIndicate(o, i)
                    : n._getContainIndicate()),
                (h[e] = l.extend({ guide: r }, t)));
            }),
        ...
        (m.prototype._getStyles = function (e) {
          var t = {};
          return (
            e &&
    ...
    function (e, t, n) {
      ...
      var l = n(0),
        ...
        g = Math.min;
      function y(e, t) {
        !0 === (t = l.extend({ usageStatistics: !0 }, t)).usageStatistics &&
          l.sendHostname &&
          l.sendHostname("calendar", "UA-129951699-1"),
      ...
      (y.prototype.destroy = function () {
        ...
        (y.prototype._initialize = function (e) {
          ...
          (this._options = l.extend(
            ...
            (this._options.week = l.extend(
              { startDayOfWeek: 0, workweek: !1 },
              l.pick(this._options, "week") || {}
            )),
          ...
          (e = l.isExisty(e) ? e : 0),
            "month" === m
              ? ((r = l.pick(this._options, "month", "startDayOfWeek") || 0),
                (s = g(
                  l.pick(this._options, "month", "visibleWeeksCount") || 0,
                  6
                )),
              ...
              ? (p.addDate(7 * e),
                ...
                (n = o[1]),
                y(f, function (e, l) {
                  (l.renderStartDate = new h(t)),
                    (l.renderEndDate = new h(n)),
        ...
        (y.prototype.setDate = function (e) {
          l.isString(e) && (e = a.parse(e)),
            (this._renderDate = new h(e)),
            this._setViewName(this._viewName),
            this.move(0),
            this.render();
        }),
        ...
        (y.prototype._getCurrentView = function () {
          ...
          return (
            "day" === e && (e = "week"), l.pick(this._layout.children.items, e)
          );
        }),
          ...
          e.registerHelper("each", function (e, t) {
            ...
            if (
              ...
              if (i.isArray(e))
                ...
                for (
                  var m = [], f = e[l.Symbol.iterator](), g = f.next();
                  !g.done;
                  g = f.next()
                )
                  m.push(g.value);
      ...
      (t.__esModule = !0),
        (t.default = function (e) {
          e.registerHelper("log", function () {
            for (
              var t = [void 0], n = arguments[arguments.length - 1], l = 0;
      ...
      (t.default = function (e) {
        e.registerHelper("with", function (e, t) {
          ...
          return (
            t.data &&
              t.ids &&
              ((l = o.createFrame(t.data)).contextPath = o.appendContextPath(
                t.data.contextPath,
                t.ids[0]
              )),
            n(e, {
          ...
          var l = {
            ...
            lookupProperty: function (e, t) {
              ...
              return null == n ||
                ...
                u.resultIsAllowed(n, l.protoAccessControl, t)
                ? n
                : void 0;
            },
            lookup: function (e, t) {
            ...
            invokePartial: function (n, l, i) {
              i.hash &&
                ((l = o.extend({}, l, i.hash)), i.ids && (i.ids[0] = !0)),
                (n = t.VM.resolvePartial.call(this, n, l, i));
              var r = o.extend({}, i, {
                  hooks: this.hooks,
              ...
              e.useDepths &&
                (a = n.depths
                  ? t != n.depths[0]
                    ...
                    : n.depths
                  : [t]),
              (s = m(e.main, s, l, n.depths || [], o, r))(t, n)
            );
          }
          return (
            (i.isTop = !0),
            (i._setup = function (i) {
              if (i.partial)
                (l.protoAccessControl = i.protoAccessControl),
                  (l.helpers = i.helpers),
                  (l.partials = i.partials),
                  (l.decorators = i.decorators),
                  (l.hooks = i.hooks);
              else {
                ...
                !(function (e, t) {
                  ...
                  (l.helpers = a),
                  e.usePartial &&
                    (l.partials = l.mergeIfNeeded(i.partials, t.partials)),
                  (e.usePartial || e.useDecorators) &&
                    (l.decorators = o.extend({}, t.decorators, i.decorators)),
                  (l.hooks = {}),
                  (l.protoAccessControl = u.createProtoAccessControl(i));
                var r = i.allowCallsToHelperMissing || n;
                s.moveHelperToHooks(l, "helperMissing", r),
                  s.moveHelperToHooks(l, "blockHelperMissing", r);
              }
            }),
        ...
        (s.prototype.toggleChildView = function (e) {
          ...
          this.children.each(function (a) {
            (t = a.container),
              ...
              i[l[n] + "Class"](t, o.classname("hidden"));
          });
        }),
    ...
    function (e, t, n) {
      ...
      (c.prototype._getContainDatesInSchedule = function (e) {
        ...
        (c.prototype.createSchedule = function (e, t) {
          var n,
            l = { data: e };
          return this.invoke("beforeCreateSchedule", l)
        ...
        (c.prototype.updateSchedule = function (e, t) {
          var n = t.start || e.start,
            o = t.end || e.end;
          return (
            ["milestone", "task", "allday", "time"].indexOf(
              (t = t || {}).category
            ) > -1 && e.set("category", t.category),
        ...
        validators: {
          ...
          dateRange: function (e, t) {
            ...
            return (
              ...
              ((n = new o(e[t[0]])),
              (l = new o(e[t[1]])),
              !(!r.isValid(n) || !r.isValid(l)) && 1 !== r.compare(n, l))
            );
          },
        },
        isValid: function () {
        ...
        u = {
                    ...
                    o(t, function (e) {
                      return (
                        ...
                        o(n.slice(0).reverse(), function (t) {
                          return (
                            !~l.inArray(l.stamp(e.valueOf()), t) ||
                            (t.push(l.stamp(r.valueOf())), !1)
                          );
                        }),
                        !1)
                      );
              ...
              o(t, function (t) {
                ...
                o(t, function (t) {
                  for (var n, o, r = e.items[t], s = 0, c = !1; !c; )
                    !1 === (o = i(a, s))
                      ? (a[0].push(r), (c = !0))
                      : r.collidesWith(a[o][s]) ||
                        ((n = o + 1),
                        l.isUndefined(a[n]) && (a[n] = []),
                        (a[n][s] = r),
                        (c = !0)),
                      (s += 1);
                }),
              ...
              o(n, function (e) {
                o(e, function (e) {
                  o(e, function (e, t) {
                    var n, o;
                    e &&
                      ((n = a.format(e.getStarts(), "YYYYMMDD")),
                      (o = a.range(
                        a.start(e.getStarts()),
                        a.end(e.getEnds()),
                        a.MILLISECONDS_PER_DAY
          ...
          limitRenderRange: function (e, t, n) {
            function l(n) {
              return (
                n.getStarts() < e &&
                  ((n.exceedLeft = !0), (n.renderStarts = new r(e))),
                n.getEnds() > t &&
                  ((n.exceedRight = !0), (n.renderEnds = new r(t))),
                n
              );
            }
      ...
      var l = n(0),
        ...
        c = {
          generateTimeArrayInRow: function (e) {
            ...
            for (n = 1; n < d; n += 1) {
              for (t = 0, o = l.pick(e, t, n); o; )
                (i =
                  o.getStarts().getTime() -
                  a.millisecondsFrom("minutes", o.valueOf().goingDuration)),
                  (r =
                    o.getEnds().getTime() +
                    a.millisecondsFrom("minutes", o.valueOf().comingDuration)),
                  Math.abs(r - i) < s && (r += s),
                  u.push([i, r]),
                  (t += 1),
                  (o = l.pick(e, t, n));
          ...
          hasCollide: function (e, t, n) {
            ...
            return (
              !!e.length &&
              ((l = c(i.bsearch(e, t, s(0), u))),
              (o = c(i.bsearch(e, t, s(1), u))),
            ...
            return (
              l.forEach(r, function (e, t) {
                ...
                (n = a.Core.getCollisionGroup(o)),
                  (l = a.Core.getMatrices(e, n)),
                  a.Week.getCollides(l),
                  (s[t] = l);
              }),
              s
            );
          ...
          _addMultiDatesInfo: function (e) {
            e.each(function (e) {
              var t = e.model;
              (e.hasMultiDates = !0),
                (e.renderStarts = a.start(t.getStarts())),
                (e.renderEnds = a.convertStartDayToLastDay(t.getEnds()));
            });
          },
          getViewModelForAlldayView: function (e, t, n) {
            ...
            return n && n.length
              ? (s._addMultiDatesInfo(n),
                ...
                (l = n.sort(i.compare.schedule.asc)),
                (o = r.getCollisionGroup(l)),
                (a = r.getMatrices(n, o)),
          ...
          findByDateRange: function (e, t, n, i, a) {
            ...
            return (
              ...
              l.forEach(n, function (n) {
                var l = n.name;
                "daygrid" === n.type
                  ? (s[l] = u.getViewModelForAlldayView(e, t, s[l]))
                  : "timegrid" === n.type &&
                    (s[l] = u.getViewModelForTimeView(e, t, s[l], p, m));
              }),
              s
            );
          },
          ...
          _stackTimeFromTop: function (e) {
            ...
            a.forEach(function (e) {
              ...
              if (
                ...
                for (
                  t = r.apply(null, u) + 1, o = 1;
                  o <= t && ((e.top = o), !(l.inArray(e.top, u) < 0));
                  o += 1
                );
              u.push(e.top);
            });
          ...
          _addMultiDatesInfo: function (e) {
            e.each(function (e) {
              var t = e.model,
                n = t.getStarts(),
                l = t.getEnds();
              (e.hasMultiDates = !i.isSameDate(n, l)),
                !t.isAllDay &&
                  e.hasMultiDates &&
                  ((e.renderStarts = i.start(n)),
                  (e.renderEnds = i.convertStartDayToLastDay(l)));
            });
          },
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t, n, y, S) {
        ...
        return (
          ...
          (C = i.appendHTMLElement(
            "div",
            _.container,
            o.classname("dayname-layout")
          )),
          (v = new d(y, C, e.theme)),
          ...
          ((E = i.appendHTMLElement(
            "div",
            _.container,
            o.classname("vlayout-area")
          )).style.height =
            i.getSize(_.container)[1] - v.container.offsetHeight + "px"),
          (w = new r(
                ...
                ? ((o = new h(
                  ...
                  l.forEach(a, function (t) {
                    (y.isReadOnly && "click" !== t) ||
                      ((_.handler[t][i] = new k[t](n, o, e, y)),
                      o.addHandler(t, _.handler[t][i], w.getPanelByName(i)));
                  }))
                : "timegrid" === t.type &&
          ...
          y.useDetailPopup &&
            ...
            (X = function (t) {
              ...
              (t.calendar = a.find(e.calendars, function (e) {
                ...
                y.isReadOnly &&
                  (t.schedule = l.extend({}, t.schedule, { isReadOnly: !0 })),
                x.render(t);
            }),
            (M = function (e) {
              e.isAllDay
          ...
          (_._beforeDestroy = function () {
            l.forEach(_.handler, function (e) {
              ...
              y.useCreationPopup &&
                (P.off("beforeCreateSchedule", I), P.destroy()),
              y.useDetailPopup &&
      ...
      l.inherit(s, r),
        ...
        (s.prototype.setHeight = function (e, t, n) {
          ...
          (e = e || this.container),
            (n || !this.isHeightForcedSet || i) &&
              (n ? (this.isHeightForcedSet = !0) : l && (t = Math.min(t, l)),
              (t = Math.max(o, t)),
              (e.style.height = t + "px"));
        }),
        ...
        (s.prototype._initPanel = function (e, t) {
          ...
          if ((a.setData(t, "panelIndex", e.index), e.isSplitter))
            return (
              a.addClass(t, o.classname("splitter")), void this.applyTheme()
            );
        ...
        (d.prototype._getStyles = function (e, t) {
          ...
          return (
            e &&
              ...
              !a &&
                o > 1 &&
                ((n = i.parseUnit(l.marginLeft)),
                (l.marginLeft = n[0] * o + n[1]))),
            l
          );
        }),
                ...
                n.setViewModelFunc(e, c))),
            {
              ...
              days: l.map(e.range, function (t, n) {
                ...
                return {
                  ...
                  left: r[n] ? r[n].left : 0,
                  backgroundColor:
                    e.range.length > 1 ? g(l, s, C) : C.backgroundColor,
                };
              }),
              exceedDate: u,
        ...
        (f.prototype._getStyles = function (e, t) {
          ...
          return (
            e &&
              ...
              !a &&
                o > 1 &&
                ((n = i.parseUnit(l.leftWidth)),
                (l.leftWidth = n[0] * o + n[1]))),
            l
          );
        }),
        (e.exports = f);
        ...
        4: function (e, t, n, l, o) {
          ...
          return (
            ...
            (i = d(n, "if").call(
              ...
              : "") +
            '"\n            style="height:' +
            c(u((i = o && d(o, "root")) && d(i, "scheduleHeight"), t)) +
            "px; line-height:" +
            c(u((i = o && d(o, "root")) && d(i, "scheduleHeight"), t)) +
            "px; border-radius: " +
            c(
              u(
                (i = (i = o && d(o, "root")) && d(i, "styles")) &&
                  d(i, "borderRadius"),
                t
              )
            ) +
          ...
          return (
            ...
            c(
              "function" ==
                typeof (a =
                  null !=
                  (a = u(n, "collapsed") || (null != t ? u(t, "collapsed") : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: "collapsed",
            ...
            c(
              e.lambda(
                (i = o && u(o, "root")) && u(i, "scheduleContainerTop"),
                t
              )
            ) +
            'px;">\n' +
            (null !=
            (i = u(n, "each").call(r, null != t ? u(t, "matrices") : t, {
              name: "each",
              hash: {},
              fn: e.program(1, o, 0),
              inverse: e.noop,
      ...
      e.exports = (l.default || l).template({
        1: function (e, t, n, l, o) {
          ...
          return (
            ...
            ";\n" +
            (null !=
            (i = u(n, "unless").call(r, o && u(o, "last"), {
              name: "unless",
              hash: {},
              fn: e.program(2, o, 0),
              inverse: e.noop,
        ...
        9: function (e, t, n, l, o) {
          ...
          return null !=
            (i = (
              ...
              o && a(o, "key"),
              "===",
              (i = o && a(o, "root")) && a(i, "collapseBtnIndex"),
              {
                name: "fi",
                hash: {},
                fn: e.program(10, o, 0),
        ...
        main: function (e, t, n, l, o) {
          ...
          return (
            ...
            (i = h(n, "if").call(
              r,
              (i = o && h(o, "root")) && h(i, "showExpandableButton"),
              {
                name: "if",
                hash: {},
                fn: e.program(4, o, 0),
    ...
    function (e, t, n) {
          ...
          l.map(g, function (e, n) {
            ...
            return (
              (t && n <= r) || (d < m && !s.isSameDate(d, m))
                ? ((l = o.pastTimeColor), (i = o.pastTimeFontWeight))
      ...
      function _(e, t, n) {
        var i = a.appendHTMLElement(
            "div",
            n,
            o.classname("timegrid-container")
          ),
          r = a.appendHTMLElement(
            "div",
            n,
            o.classname("timegrid-sticky-container")
          );
        (n.style.position = "relative"),
          ...
          this.options.timezones.length < 1 &&
            (this.options.timezones = [{ timezoneOffset: c.getOffset() }]),
          (this.intervalID = 0),
          (this.timerID = 0),
          (this._scrolled = !1),
          (this._cacheParentViewModel = null),
      ...
      l.inherit(_, d),
        ...
        (_.prototype._getTopPercentByTime = function (e) {
          var t,
            ...
            o = s.raw(e || new y()),
            a =
              l.range(n.hourStart, n.hourEnd).length * s.MILLISECONDS_PER_HOUR,
            r =
              s.millisecondsFrom("hour", o.h) +
              s.millisecondsFrom("minutes", o.m) +
              s.millisecondsFrom("seconds", o.s) +
              o.ms;
          return (
            (t = i.ratio(a, 100, r)),
        ...
        (_.prototype._getHourmarkerViewModel = function (e, t, n) {
          ...
          return (
            l.forEach(n, function (n, l) {
              s.isSameDate(e, n) &&
                ((o = t[l] ? t[l].left : 0), (i = t[l] ? t[l].width : 0));
            }),
          ...
          (n.innerHTML = ""),
            ...
            l.forEach(e, function (e, l) {
              (u = l === f),
                ...
                (c = new h(
                  r,
                  a.appendHTMLElement("div", n, o.classname("time-date")),
                  i
                )).render(l, e, d),
                p.addChild(c),
                (g += 1);
          ...
          (this._cacheParentViewModel = e),
            ...
            c &&
              ...
              this._renderChildren(
                n,
                r,
                a.find(o.classname(".timegrid-schedules-container"), i),
                e.theme
              ),
              (this._hourLabels = a.find("ul", i)),
              (this.hourmarkers = a.find(
                o.classname(".timegrid-hourmarker"),
                i,
                !0
              )),
                ...
                r
                  ...
                  : l.forEach(t, function (t) {
                      ...
                      (t.style.top = e.hourmarkerTop + "%"),
                        ...
                        l && (l.innerHTML = g(e.hourmarkerTimzones[r]));
                    });
            }, this));
        }),
        ...
        (_.prototype.scrollToNow = function () {
          ...
          this.hourmarkers &&
            ...
            (o = function () {
              n > e - l
                ? ((n -= 10), (i.scrollTop = n), u.requestAnimFrame(o))
                : (i.scrollTop = e - l);
            }),
        ...
        (_.prototype.onTick = function () {
          this.timerID && (clearTimeout(this.timerID), (this.timerID = null)),
            this.intervalID ||
              (this.intervalID = setInterval(l.bind(this.onTick, this), 6e4)),
        ...
        (_.prototype._getStyles = function (e, t) {
          ...
          return (
            e &&
              ...
              (l.additionalTimezoneBackgroundColor =
                e.week.timegridLeftAdditionalTimezone.backgroundColor ||
                l.leftBackgroundColor),
              (l.displayTimezoneLabelHeight =
                e.week.timegridLeftTimezoneLabel.height),
              (l.displayTimezoneLabelBackgroundColor =
              ...
              (l.currentTimeBulletBackgroundColor =
                e.week.currentTimeLineBullet.backgroundColor),
              (l.currentTimeTodayBorderTop =
                e.week.currentTimeLineToday.border),
              (l.currentTimeRightBorderTop =
        ...
        (_.prototype._onClickStickyContainer = function (e) {
          var t = r.getEventTarget(e);
          a.closest(t, o.classname(".timegrid-timezone-close-btn")) &&
      ...
      function d(e, t, n) {
        r.call(this, t),
          ...
          this.options.isToday &&
            a.addClass(this.container, o.classname("today")),
          this.applyTheme();
      }
      l.inherit(d, r),
        ...
        (d.prototype._getScheduleViewBoundY = function (e, t) {
          ...
          return (
            ...
            n + f > s && ((n = s - f), (d = !0)),
            {
              top: f,
              height:
                Math.max(n, this.options.minHeight) -
        ...
        (d.prototype.getScheduleViewBound = function (e, t) {
          ...
          return (
            r === i.bgColor && (r = null),
            l.extend({ isReadOnly: a, travelBorderColor: r }, n, o)
          );
        }),
        (d.prototype._getBaseViewModel = function (e, t, n) {
          var o,
      ...
      (function (t) {
        ...
        (r.DIRECTION = { INSIDE: 0, TOP: 1, RIGHT: 2, BOTTOM: 3, LEFT: 4 }),
          ...
          (r.prototype.getRealSize = function (e) {
            ...
            return (
              (t =
                parseFloat(l.getPropertyValue("border-top-width")) +
                parseFloat(l.getPropertyValue("border-bottom-width"))),
              (n =
                parseFloat(l.getPropertyValue("padding-top")) +
      ...
      e.exports = (l.default || l).template({
        1: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              typeof (a =
                null != (a = d(n, "index") || (o && d(o, "index"))) ? a : s) ===
                c
                ? a.call(r, {
                    name: "index",
                    hash: {},
        ...
        4: function (e, t, n, l, o) {
          ...
          return (
            ...
            (i = r(n, "if").call(
              a,
              (i = o && r(o, "root")) && r(i, "showHourMarker"),
              {
                name: "if",
                hash: {},
                fn: e.program(8, o, 0),
        ...
        8: function (e, t, n, l, o) {
          ...
          return (
            ...
            c(u((i = o && d(o, "root")) && d(i, "hourmarkerTop"), t)) +
            "%; margin-top: calc(6px - " +
            c(
              u(
                (i = (i = o && d(o, "root")) && d(i, "styles")) &&
        ...
        15: function (e, t, n, l, o) {
          ...
          return (
            ...
            ";\n" +
            (null !=
            (i = d(n, "unless").call(r, o && d(o, "last"), {
              name: "unless",
              hash: {},
              fn: e.program(16, o, 0),
              inverse: e.noop,
      ...
      e.exports = (l.default || l).template({
          ...
          return (
            ...
            (i = h(n, "if").call(
              ...
              (h(n, "and") || (t && h(t, "and")) || s).call(
                ...
                (i = o && h(o, "root")) && h(i, "showTimezoneCollapseButton"),
                {
                  name: "and",
                  hash: {},
                  data: o,
        ...
        4: function (e, t, n, l, o) {
          ...
          return (
            ...
            (i = d(n, "if").call(
              r,
              (i = o && d(o, "root")) && d(i, "timezonesCollapsed"),
              {
                name: "if",
                hash: {},
                fn: e.program(5, o, 0),
        ...
        (s.prototype.destroy = function () {
          ...
          (s.prototype._clearGuideElement = function () {
            this._showOriginScheduleBlocks(),
              ...
              l.browser.msie ||
                a.removeClass(t.document.body, o.classname("dragging")),
              (this._dragStartXIndex =
          ...
          (s.prototype._hideOriginScheduleBlocks = function (e) {
            var t = o.classname("weekday-schedule-block-dragging-dim"),
              n = a.find(
                o.classname(".weekday-schedule-block"),
          ...
          (s.prototype.refreshGuideElement = function (e, t, n, l) {
            ...
            r.requestAnimFrame(function () {
              (i.style.left = e + "%"),
                (i.style.width = t + "%"),
                n
                  ? a.addClass(i, o.classname("weekday-exceed-left"))
                  : a.removeClass(i, o.classname("weekday-exceed-left")),
                l
                  ? a.addClass(i, o.classname("weekday-exceed-right"))
                  : a.removeClass(i, o.classname("weekday-exceed-right"));
            });
          }),
      ...
      (p.prototype.destroy = function () {
        ...
        (p.prototype.checkExpectedCondition = function (e) {
          ...
          return (
            ...
            !(
              !(n = r.closest(e, o.classname(".weekday-schedules"))) &&
              i !== o.classname("weekday-schedules")
            ) &&
            ((e = n ? n.parentNode : e.parentNode),
            !(
              !(t = (i = r.getClass(e)).match(o.daygrid.getViewIDRegExp)) ||
              t.length < 2
        ...
        (p.prototype._onClick = function (e) {
          ...
          this.checkExpectedCondition(e.target) &&
            ...
            setTimeout(function () {
              l._requestOnClick && (l.fire("click", n), l._createSchedule(n)),
                (l._requestOnClick = !1);
            }, h));
        }),
        ...
        (p.prototype.invokeCreationClick = function (e) {
          var t;
          (t = this._retriveScheduleDataFromDate(this.view, e.start)(e.start)),
            this.fire("click", t),
            this._createSchedule(t);
        }),
        a.mixin(c, p),
    ...
    function (e, t, n) {
      ...
      (a.prototype.destroy = function () {
        ...
        (a.prototype.initializeGuideElement = function () {
          o.addClass(
            this.guideElement,
            l.classname("daygrid-guide-creation-block")
          );
        }),
        ...
        (a.prototype._refreshGuideElement = function (e, t) {
          ...
          (n = a.grids[r] ? a.grids[r].left : 0),
            (l = this._getGuideWidth(r, s, a.grids)),
        ...
        (a.prototype._createGuideElement = function (e) {
          ...
          o
            .find(l.classname(".weekday-grid"), t)
      ...
      (d.prototype.destroy = function () {
        ...
        (d.prototype.checkExpectedCondition = function (e) {
          ...
          return (
            ...
            !(
              !(t = (n = a.getClass(e)).match(o.daygrid.getViewIDRegExp)) ||
              t.length < 2
            ) &&
            l.pick(this.view.children.items, t[1])
          );
        ...
        (d.prototype._updateSchedule = function (e) {
          var t,
            ...
            o = new u(n.end);
          (o = o.addDate(l)),
            (o = new u(r.maxDate(i.end(n.start), o))),
            (t = r.getScheduleChanges(n, ["end"], { end: o })),
            this.fire("beforeUpdateSchedule", {
              schedule: n,
              changes: t,
              start: n.getStarts(),
        ...
        (s.prototype.destroy = function () {
          ...
          (s.prototype._clearGuideElement = function () {
            i.remove(this.guideElement),
              l.browser.msie ||
                i.removeClass(t.document.body, o.classname("resizing-x")),
              this.scheduleBlockElement &&
                i.removeClass(
                  this.scheduleBlockElement,
                  o.classname("weekday-schedule-block-dragging-dim")
                ),
              (this.getScheduleDataFunc = null);
          }),
          ...
          (s.prototype._onDragStart = function (e) {
            ...
            l.browser.msie ||
              i.addClass(t.document.body, o.classname("resizing-x")),
    ...
    function (e, t, n) {
      ...
      (a.prototype.destroy = function () {
        ...
        (a.prototype.checkExpectCondition = function (e) {
          var t, n;
          return (
            !!(t = i.closest(e, o.classname(".time-date"))) &&
            !(
              !(n = i.getClass(t).match(o.time.getViewIDRegExp)) || n.length < 2
            ) &&
      ...
      (m.prototype.destroy = function () {
        ...
        (m.prototype.checkExpectedCondition = function (e) {
          var t,
            n = r.getClass(e);
          return (
            n === o.classname("time-date-schedule-block-wrap") &&
              ((e = e.parentNode), (n = r.getClass(e))),
            !(!(t = n.match(o.time.getViewIDRegExp)) || t.length < 2) &&
              l.pick(this.timeGridView.children.items, t[1])
          );
        }),
        ...
        (m.prototype._onDrag = function (e, t, n) {
          ...
          o &&
            ((l = o(e.originEvent)),
            n && n(l),
            this.fire(t || "timeCreationDrag", l));
        }),
        ...
        (m.prototype._onDragEnd = function (e) {
          ...
          this.dragHandler.off(
            ...
            this._onDrag(e, "timeCreationDragend", function (e) {
              var l = [n.nearestGridTimeY, e.nearestGridTimeY].sort(
                i.compare.num.asc
              );
        ...
        (m.prototype._onClick = function (e) {
          ...
          this.dragHandler.off(
            ...
            (t = this.checkExpectedCondition(e.target)) &&
              ...
              setTimeout(function () {
                o._requestOnClick &&
                  (o.fire("timeCreationClick", l), o._createSchedule(l)),
                  (o._requestOnClick = !1);
              }, p),
              (this._dragStart = this._getScheduleDataFunc = null));
        }),
        ...
        (d.prototype.destroy = function () {
          ...
          (d.prototype._refreshGuideElement = function (e, t, n, l, r) {
            ...
            (s.style.top = e + "px"),
              ...
              (c.innerHTML =
                o.format(n, "HH:mm") + " - " + o.format(l, "HH:mm")),
              r
          ...
          (d.prototype._limitStyleData = function (e, t, n, o) {
            ...
            return [
              (e = l.limit(e, [0], [i[0]])),
              (t = l.limit(e + t, [0], [i[0]]) - e),
              (n = l.limitDate(n, i[2], i[3])),
              (o = l.limitDate(o, i[2], i[3])),
            ];
          }),
    ...
    function (e, t, n) {
      ...
      (d.prototype.destroy = function () {
        ...
        (d.prototype.checkExpectCondition = function (e) {
          return (
            !!a.closest(e, o.classname(".time-schedule")) &&
            this._getTimeView(e)
          );
        }),
        (d.prototype._getTimeView = function (e) {
          ...
          return (
            !!n &&
            !(
              !(t = a.getClass(n).match(o.time.getViewIDRegExp)) || t.length < 2
            ) &&
            l.pick(this.timeGridView.children.items, Number(t[1]))
          );
        }),
        ...
        (d.prototype._onDragStart = function (e) {
          ...
          s &&
            ...
            (i = u.schedules.items[l]).isReadOnly ||
              ...
              (n = this._dragStart =
                t(e.originEvent, { targetModelID: l, model: i })),
              this.dragHandler.on(
                {
                  drag: this._onDrag,
                  dragEnd: this._onDragEnd,
        ...
        (d.prototype._onClick = function (e) {
          ...
          this.dragHandler.off(
            ...
            n &&
              l &&
              ((t = n(e.originEvent, { targetModelID: l.targetModelID })),
      ...
      (function (t) {
        ...
        (f.prototype.destroy = function () {
          ...
          (f.prototype._clearGuideElement = function () {
            l.browser.msie ||
              i.removeClass(t.document.body, o.classname("dragging")),
              this._guideLayer && this._guideLayer.destroy(),
              this._showOriginScheduleBlocks(),
              (this.guideElement =
                this._getTopFunc =
          ...
          (f.prototype._refreshGuideElement = function (e, t, n) {
            ...
            a.requestAnimFrame(function () {
              o._guideLayer &&
                ...
                o._guideLayer.setContent(c(l.extend({ model: t }, n))));
            });
          }),
          ...
          (f.prototype._onDrag = function (e) {
            ...
            l.browser.msie ||
              i.addClass(t.document.body, o.classname("dragging")),
          ...
          (f.prototype._resetGuideLayer = function () {
            this._guideLayer &&
              ...
              this._guideLayer.setContent(
                c(l.extend({ model: this._model }, this._viewModel))
              ),
    ...
    function (e, t, n) {
      ...
      (d.prototype.destroy = function () {
        ...
        (d.prototype._onDrag = function (e, t, n) {
          ...
          o &&
            i &&
            ((l = o(e.originEvent, { targetModelID: i.targetModelID })),
            n && n(l),
            this.fire(t || "timeResizeDrag", l));
        }),
        (d.prototype._updateSchedule = function (e) {
          var t,
            n,
        ...
        (d.prototype._onDragEnd = function (e) {
          ...
          this.dragHandler.off(
            ...
            n &&
              ...
              })).range = [l.timeY, new r(t.timeY).addMinutes(30)]),
              (t.nearestRange = [
                l.nearestGridTimeY,
      ...
      (function (t) {
        ...
        (c.prototype.destroy = function () {
          ...
          (c.prototype._clearGuideElement = function () {
            ...
            l.browser.msie ||
              i.removeClass(t.document.body, o.classname("resizing")),
          ...
          (c.prototype._onDragStart = function (e) {
            var n,
              ...
              r = e.schedule;
            l.browser.msie ||
              i.addClass(t.document.body, o.classname("resizing")),
              a &&
                r &&
                ((this._startGridY = e.nearestGridY),
        ...
        return (
          ...
          (C._beforeDestroy = function () {
            v.destroy(),
              ...
              S.useCreationPopup &&
                S.useDetailPopup &&
                E.off("beforeUpdateSchedule", I),
              S.useCreationPopup &&
                (P && P.off("beforeCreateSchedule", void 0),
                E.off("saveSchedule", D),
                E.destroy()),
              S.useDetailPopup &&
                (w.off("clickSchedule", X),
                x.off("beforeUpdateSchedule", I),
    ...
    function (e, t, n) {
      ...
      function p(e, t, n) {
        ...
        (o = (e = e || {}) ? e.month : {}),
          ...
          (this.options.grid.header = l.extend(
            { height: 34 },
            l.pick(o, "grid", "header")
          )),
          (this.options.grid.footer = l.extend(
            { height: 3 },
            l.pick(o, "grid", "footer")
          )),
        ...
        (p.prototype._renderChildren = function (e, t, n) {
          ...
          (e.innerHTML = ""),
            ...
            l.forEach(t, function (t) {
              ...
              (l = a.appendHTMLElement(
                "div",
                e,
                o.classname("month-week-item")
              )),
                (c = new d(
                  {
                    renderMonth: u,
            ...
            this.children.each(function (t) {
              var l = i.start(t.options.renderStartDate),
                ...
                s = {
                  eventsInDateRange: r,
                  range: i
                    .range(i.start(l), i.end(a), i.MILLISECONDS_PER_DAY)
                    .slice(0, e.length),
                  grids: e,
    ...
    function (e, t, n) {
      ...
      l.inherit(p, s),
        ...
        (p.prototype._getRenderLimitIndex = function (e) {
          ...
          return (
            (t = d((o -= i + a) / (n.scheduleHeight + n.scheduleGutter))),
            r || (r = t),
            h(t, r)
          );
        }),
        ...
        (p.prototype.render = function (e) {
          ...
          this.options.visibleWeeksCount ||
            ...
            (p.innerHTML = c(m)),
            (t = a.find(o.classname(".weekday-schedules"), p)) &&
              ((t.innerHTML = u(m)),
              i.setAutoEllipsis(o.classname(".weekday-schedule-title"), p, !0));
        }),
        ...
        4: function (e, t, n, l, o) {
          ...
          return (
            ...
            (i = (
              ...
              null != t ? a(t, "top") : t,
              "<",
              (i = o && a(o, "root")) && a(i, "renderLimitIdx"),
              {
                name: "fi",
                hash: {},
                fn: e.program(5, o, 0),
          ...
          return (
            ...
            c(
              (
                ...
                r,
                t,
                (i = o && u(o, "root")) && u(i, "dates"),
                (i = o && u(o, "root")) && u(i, "scheduleBlockHeight"),
                (i = o && u(o, "root")) && u(i, "gridHeaderHeight"),
                {
            ...
            c(
              e.lambda(
                (i = o && u(o, "root")) && u(i, "scheduleBlockGutter"),
                t
              )
            ) +
            'px">\n' +
        ...
        10: function (e, t, n, l, o) {
          ...
          return (
            ...
            (i = d(n, "if").call(
              ...
              : "") +
            '"\n             style="height:' +
            s(r((i = o && d(o, "root")) && d(i, "scheduleHeight"), t)) +
            "px; line-height:" +
            s(r((i = o && d(o, "root")) && d(i, "scheduleHeight"), t)) +
            "px; border-radius: " +
            s(
      ...
      (r.prototype.destroy = function () {
        ...
        (r.prototype._onClick = function (e) {
          var t,
            ...
            r =
              a.closest(e.target, o.classname(".weekday-schedule-block")) ||
              a.closest(e.target, o.classname(".month-more-schedule"));
          (t = a.closest(e.target, o.classname(".weekday-exceed-in-month"))) &&
            n.fire("clickMore", {
    ...
    function (e, t, n) {
      ...
      function m(e) {
        return (
          r.closest(e, o.classname(".weekday-grid")) &&
          !r.closest(e, o.classname(".weekday-exceed-in-month"))
        );
      }
      (p.prototype.destroy = function () {
        this.dragHandler.off(this),
          ...
          this.dragHandler.off(
            ...
            this.getScheduleData &&
              ((t = this.getScheduleData(e.originEvent)) &&
                ((l.end = new d(t.date)),
                (l.isAllDay = !0),
                (n = [l.start, l.end].sort(a.compare.num.asc)),
                (l.start = new d(n[0])),
                (l.end = i.end(n[1])),
                this._createSchedule(l)),
        ...
        (p.prototype._onClick = function (e) {
          ...
          m(e.target) &&
            ...
            setTimeout(function () {
              l._requestOnClick &&
                (l.fire("monthCreationClick", t),
                (n = l._adjustStartAndEndTime(new d(t.date), new d(t.date))),
                l._createSchedule({
                  start: n.start,
                  end: n.end,
                  isAllDay: !1,
      ...
      (d.prototype.destroy = function () {
        ...
        (d.prototype._onDragEnd = function (e) {
          ...
          this.dragHandler.off(
            ...
            this.getScheduleData &&
              ((t = this.getScheduleData(e.originEvent)) &&
                ((n = new c(o.schedule.getStarts())),
                (l = new c(t.date)),
                (o.end = l),
                n <= o.end && this._updateSchedule(o)),
        ...
        (d.prototype.render = function (e) {
          ...
          (this._viewModel = l.extend(e, {
            ...
            e.schedules.length <= 10
              ...
              : (C += 10 * (y.scheduleGutter + y.scheduleHeight)),
      ...
      e.exports = (l.default || l).template({
        ...
        2: function (e, t, n, l, o) {
          ...
          return (
            ...
            c(u((i = o && d(o, "root")) && d(i, "scheduleHeight"), t)) +
            "px; margin-top: " +
            c(u((i = o && d(o, "root")) && d(i, "scheduleGutter"), t)) +
            "px; border-radius: " +
            c(u((i = o && d(o, "root")) && d(i, "borderRadius"), t)) +
            ";\n" +
            (null !=
            (i = d(n, "if").call(
              r,
      ...
      var l = n(0),
        ...
        c = {
          ...
          "taskTitle-tmpl": function () {
            return (
              '<span class="' + r.classname("left-content") + '">Task</span>'
            );
          },
          "alldayTitle-tmpl": function () {
            return (
              '<span class="' + r.classname("left-content") + '">All Day</span>'
            );
          },
          ...
          "goingDuration-tmpl": function (e) {
            var t = e.goingDuration,
              ...
              l = t % 60;
            return (
              "GoingTime " + i.leadingZero(n, 2) + ":" + i.leadingZero(l, 2)
            );
          },
          "comingDuration-tmpl": function (e) {
            var t = e.goingDuration,
              ...
              l = t % 60;
            return (
              "ComingTime " + i.leadingZero(n, 2) + ":" + i.leadingZero(l, 2)
            );
          },
          ...
          "timezoneDisplayLabel-tmpl": function (e, t) {
            ...
            return (
              l.isUndefined(t) &&
                ...
                (a = Math.abs(e % 60)),
                (t = n + i.leadingZero(o, 2) + ":" + i.leadingZero(a, 2))),
              t
            );
          },
          ...
          "popupDetailDate-tmpl": function (e, t, n) {
            ...
            return e
              ? i.format(t, "YYYY.MM.DD") +
                  (l ? "" : " - " + i.format(n, "YYYY.MM.DD"))
              : i.format(t, "YYYY.MM.DD hh:mm tt") + " - " + i.format(n, o);
          },
