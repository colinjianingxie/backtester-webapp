...
from main.models import Backtest, BacktestResults
'''
def create_model_parameters(model_name):
...
def create_parameters(model_name):
    ...
    return {
        ...
        'model': create_model_parameters(model_name)
    }

def create_backtest(ticker_names, initial_capital, heartbeat, strategy_name):

    model_parameters = create_parameters(strategy_name)
